...
export const OrderPrescriptions = ({ prescriptions }) => {
  ...
  const handleOpenLightbox = url => {
    const selectedImage = prescriptions.findIndex(index => index === url);
  ...
  const settings2 = {
    ...
    variableWidth: true,
    centerPadding: '0px',
    slidesToShow: prescriptions.length > 3 ? 3 : prescriptions.length
  };
    ...
    <RootStyle>
      ...
      <Box
        sx={{
          ...
          ...(prescriptions.length === 1 && { maxWidth: THUMB_SIZE * 1 + 16 }),
          ...(prescriptions.length === 2 && { maxWidth: THUMB_SIZE * 2 + 32 }),
          ...(prescriptions.length === 3 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...(prescriptions.length === 4 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...(prescriptions.length >= 5 && { maxWidth: THUMB_SIZE * 6 }),
      ...
      <LightboxModal
        ...
        mainSrc={prescriptions[selectedImage]}
