...
export const Carousel = ({ photos }) => {
  ...
  const handleOpenLightbox = url => {
    const selectedImage = photos.findIndex(index => index === url);
    ...
    <RootStyle>
      ...
      <Box
        sx={{
          ...
          ...(photos.length === 1 && { maxWidth: THUMB_SIZE * 1 + 16 }),
          ...(photos.length === 2 && { maxWidth: THUMB_SIZE * 2 + 32 }),
          ...(photos.length === 3 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...(photos.length === 4 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...(photos.length >= 5 && { maxWidth: THUMB_SIZE * 6 }),
          ...(photos.length > 2 && {
            position: 'relative',
            '&:before, &:after': {
              top: 0,
